// to show details of the products
...
function Show() {
    ...
    async function formSubmitHandler(event) {
        ...
        setComment('')
         ...
         // addToCartHandler() method to add items in the cart
         function addToCartHandler(){

            // creating the product's object and add it to the addToCart() method
            const product = {
                id:params.id,
                name:name,
                price:price,
            ...
            //  now we will call addToCart() method by passing product's object in it
            addToCart(product);
        }
